...
async function runDevSeed() {
  ...
  await db.execute(sql`insert into permissions (code,module,description) values ('reports.read','reports','Consultar relatórios operacionais') on conflict (code) do nothing`);
