  ...
  return (
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        {canReceive && (
          <Link href={`/app/purchase-receipts/new?purchaseOrderId=${order.id}`} className="rounded-xl bg-blue-600 hover:bg-blue-700 px-4 py-2.5 text-sm font-semibold text-white">
            Receber mercadorias
          </Link>
        )}
      </div>
